...
const struct regval_list qvga_ov7670[] PROGMEM = {
    {REG_COM14, 0x19}, {0x72, 0x11},     {0x73, 0xf1},       {REG_HSTART, 0x16},
    {REG_HSTOP, 0x04}, {REG_HREF, 0xa4}, {REG_VSTART, 0x02}, {REG_VSTOP, 0x7a},
    {REG_VREF, 0x0a},  {0xff, 0xff}, /* END MARKER */
};
...
void setup() {
    ...
    setColor();
    Serial.println("Hey4");
    writeReg(0x11, 10);  // Earlier it had the value:writeReg(0x11, 12); New
                         // version works better for me :) !!!!
    Serial.println("Hey5");
}

void loop() { captureImg(320, 240); }
