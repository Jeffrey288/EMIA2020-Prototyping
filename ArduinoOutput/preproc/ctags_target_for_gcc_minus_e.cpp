...
const 
# 105 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino" 3
     __attribute__((__progmem__)) 
# 105 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
             uint8_t scan_bracelet[12 * 96] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
void tft_printc(short x, short y, const char chr, uint16_t color = 0x0000, uint16_t bg = 0xFFFF) {
    ...
    for (int r = 0; r < 16; r++) {
        uint8_t temp = 
# 229 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino" 3
                      (__extension__({ uint16_t __addr16 = (uint16_t)((uint16_t)(
# 229 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
                      asciiBitmap[chr - ' '] + r
# 229 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino" 3
...
void _tft_printbigc(short x, short y, const char chr, short w = 8, short h = 16, uint16_t color = 0x0000, uint16_t bg = 0xFFFF) {
    ...
    for (int r = 0; r < h; r++) {
        int rr = (r + 0.5) / h * 16;
        uint8_t temp = 
# 244 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino" 3
                      (__extension__({ uint16_t __addr16 = (uint16_t)((uint16_t)(
# 244 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
                      asciiBitmap[chr - ' '] + rr
# 244 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino" 3
                      )); uint16_t __result; __asm__ __volatile__ ( "lpm %A0, Z+" "\n\t" "lpm %B0, Z" "\n\t" : "=r" (__result), "=z" (__addr16) : "1" (__addr16) ); __result; }))
# 244 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
...
void loop() {
    ...
    if (state == IDLE_STATE) {
        ...
        sprintf(buff, "$ %5s", amount.c_str());
        tft_prints(70, 127-16, buff, 0xF800);
    } else if (state == SCAN_FACE) {
        ...
        amount = "";
        tft_printbigs(0, 35, "Transaction", 1.5, 0xF800, 0x07E0);
        tft_printbigs(0, 65, "Success!", 1.5, 0xF800, 0x07E0);
        _delay_ms(2500);
        state = IDLE_STATE;
        tft.fillScreen(0xFFFF);
    } else if (state == CANCELLED) {
        amount = "";
        tft_printbigs(0, 35, "Transaction", 1.5, 0xF800, 0xFFE0);
        tft_printbigs(0, 65, "Cancelled!", 1.5, 0xF800, 0xFFE0);
        _delay_ms(1500);
        state = IDLE_STATE;
        tft.fillScreen(0xFFFF);
    }
