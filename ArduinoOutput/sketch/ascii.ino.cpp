#include <Arduino.h>
#line 211 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
void tft_printi(short x, short y, short w, short h, const uint8_t *img);
#line 300 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
void eventListener(char c);
#line 350 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
void setup(void);
#line 363 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
void loop();
#line 0 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
#line 1 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\ascii.ino"
#ifndef __FONT_H
#define __FONT_H
...
const PROGMEM uint16_t asciiBitmap[95][16] = {
...
#line 1 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
        ...
        switch (c) {
            ...
            case 'D':
                if (state == IDLE_STATE) {
                    ...
                    tft_printbigs(20, 50, "SUCCESS!", 1.5, ST7735_BLACK, ST7735_GREEN);
                    _delay_ms(500);
                    tft.fillScreen(ST77XX_WHITE);
                    state = SCAN_FACE;
...
void loop() {
    ...
    if (state == IDLE_STATE) {
        ...
        tft_printbigs(0, 20, buff, 2.0, ST7735_RED);
    } else if (state == SCAN_BRACELET) {
        ...
        amount = "";
        tft_printbigs(0, 35, "Transaction", 1.5, ST7735_RED, ST7735_GREEN);
        tft_printbigs(0, 65, "Success!", 1.5, ST7735_RED, ST7735_GREEN);
        _delay_ms(2500);
        state = IDLE_STATE;
        tft.fillScreen(ST77XX_WHITE);
    } else if (state == CANCELLED) {
        amount = "";
        tft_printbigs(0, 35, "Transaction", 1.5, ST7735_RED, ST7735_YELLOW);
        tft_printbigs(0, 65, "Cancelled!", 1.5, ST7735_RED, ST7735_YELLOW);
        _delay_ms(1500);
        state = IDLE_STATE;
        tft.fillScreen(ST77XX_WHITE);
    }
