...
#line 302 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
void eventListener(char c);
#line 351 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
void setup(void);
#line 364 "c:\\Users\\pinkp\\Documents\\GitHub\\EMIA\\project\\main.ino"
void loop();
...
void loop() {
    ...
    if (state == IDLE_STATE) {
        ...
        amount = "";
        tft_printbigs(0, 50, "Transaction", 1.5, ST7735_RED, ST7735_GREEN);
        tft_printbigs(0, 80, "Success!", 1.5, ST7735_RED, ST7735_GREEN);
        _delay_ms(2500);
        state = IDLE_STATE;
        tft.fillScreen(ST77XX_WHITE);
    } else if (state == CANCELLED) {
        amount = "";
        tft_printbigs(0, 50, "Transaction", 1.5, ST7735_RED, ST7735_YELLOW);
        tft_printbigs(0, 80, "Cancelled!", 1.5, ST7735_RED, ST7735_YELLOW);
        _delay_ms(1500);
        state = IDLE_STATE;
        tft.fillScreen(ST77XX_WHITE);
    }
